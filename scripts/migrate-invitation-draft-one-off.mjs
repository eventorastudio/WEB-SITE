...
import { migrateInvitationDraftToCurrentSchema } from '../admin/invitations/core/draft-migrations.js?v=phase125-remove-draft-canonical-diagnostics-20260824';
import {
    deserializeInvitationDraft,
    findCanonicalDifferences,
    serializeInvitationDraft
} from '../admin/invitations/core/draft-persistence-schema.js?v=phase125-remove-draft-canonical-diagnostics-20260824';
