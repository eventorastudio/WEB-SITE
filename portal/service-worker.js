const CACHE_NAME = 'eventora-prestige-static-v4';
const STATIC_ASSETS = [
    ...
    './vendor/zxing-browser-0.2.0.min.js', '../shared/guest-contract.js', '../shared/checkin-numbering.js', '../shared/qr-code.js'
];
...
self.addEventListener('fetch', (event) => {
    ...
    if (requestUrl.pathname.startsWith('/admin/') || isFirebaseRequest(requestUrl) || isPrivatePortalData(requestUrl) || requestUrl.search) return;
