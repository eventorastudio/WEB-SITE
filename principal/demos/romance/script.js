const EVENT = Object.freeze({
  ...
  locationUrl: "https://www.google.com/maps/search/?api=1&query=Arteaga+Coahuila",
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('opening-guest').textContent = `Con mucho cariño, ${guestName}, queremos invitarte a ser parte de nuestra historia.`;
  document.querySelectorAll('[data-guest-message]').forEach((element) => {
    element.textContent = `Con mucho cariño, ${guestName}, queremos invitarte a ser parte de nuestra historia.`;
  });
  document.querySelectorAll('[data-pass-message]').forEach((element) => {
    element.textContent = passes === 1 ? "Hemos guardado un lugar para ti." : `Hemos guardado ${passes} lugares para compartir este día contigo.`;
  });
