...
export const PERMISSIONS = Object.freeze({
    ...
    INVITATIONS_EDIT: 'invitations:edit',
...
const ROLE_PERMISSIONS = Object.freeze({
    ...
    [USER_ROLES.ADMINISTRADOR]: [PERMISSIONS.EVENTS_VIEW, PERMISSIONS.EVENTS_EDIT, PERMISSIONS.INVITATIONS_EDIT, PERMISSIONS.GUESTS_VIEW, PERMISSIONS.GUESTS_EDIT, PERMISSIONS.PROFILE_VIEW, PERMISSIONS.PROFILE_EDIT, PERMISSIONS.SETTINGS_VIEW, PERMISSIONS.SETTINGS_EDIT],
    [USER_ROLES.DISENADOR]: [PERMISSIONS.EVENTS_VIEW, PERMISSIONS.INVITATIONS_EDIT, PERMISSIONS.PROFILE_VIEW, PERMISSIONS.PROFILE_EDIT, PERMISSIONS.SETTINGS_VIEW],
